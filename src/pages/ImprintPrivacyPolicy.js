    ...
    >
      ...
      <div className="flex justify-center">
        <div className="mt-4 w-2/3 h-auto text-justify">
          <h1 className="text-2xl text-center font-bold mb-10">Privacy Policy for JohnChan.com</h1>
          <p>
            At JohnChan.com, one of our main priorities is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and recorded by
            JohnChan.com and how we use it.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            JohnChan.com. This policy is not applicable to any information collected offline or via
          ...
          <p>
            JohnChan.com follows a standard procedure of using log files. These files log visitors
          ...
          <h2 className="font-bold mt-6">Advertising Partners Privacy Policies</h2>
          <p>
            You may consult this list to find the Privacy Policy for each of the advertising
            partners of JohnChan.com.
            <br />
            ...
            JohnChan.com, which are sent directly to users' browser. They automatically receive your
            ...
            <br />
            Note that JohnChan.com has no access to or control over these cookies that are used by
            third-party advertisers.
          </p>
          <h2 className="font-bold mt-6">Third Party Privacy Policies</h2>
          <p>
            JohnChan.com's Privacy Policy does not apply to other advertisers or websites. Thus, we
          ...
          <p>
            ...
            <br />
            JohnChan.com does not knowingly collect any Personal Identifiable Information from
          ...
          <p className="mb-20">
            Any inquiries shall be sent to John Chan @ {address1}
            <br />
          </p>
        </div>
      </div>
